...
local number_spawnprotection			= xlib.makenumberwang {x=5, y=65, w=35, parent=panel_entering }
local label_spawnprotection			= xlib.makelabel{ x=number_spawnprotection.x+40, y=number_spawnprotection.y+2, w=500, h=15, parent=panel_entering, label="Spawnprotection" }
